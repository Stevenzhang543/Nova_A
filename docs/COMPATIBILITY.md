...
Nova_A 3.0.0 writes Project Format 2, schema 22, engine version 3.0.0. It accepts every publicly supported schema from 5 through 22.

Import is transactional:

1. Parse and bound the selected file.
2. Reject a newer major/schema before editor state changes.
...
Downgrading a schema-22 project into an older Nova_A version is not supported. Use the automatic pre-upgrade backup to return to the original file.
