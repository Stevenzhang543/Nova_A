...
export const PLATFORM_SUPPORT_MATRIX: readonly PlatformSupportEntry[] = Object.freeze([
  Object.freeze({ id: 'windows', label: 'Windows', tier: 'tier-1', architectures: ['x86_64'] as const, editor: true, runtime: true, referenceMatrixPassed: true, reason: 'Windows x86-64 editor/runtime and installer matrix passed for 4.0.0.' }),
  Object.freeze({ id: 'web', label: 'Web', tier: 'tier-1', architectures: ['x86_64'] as const, editor: false, runtime: true, referenceMatrixPassed: true, reason: 'Chromium, Firefox and WebKit runtime reference matrix passed for 4.0.0.' }),
...
export function platformTierLabel(tier: PlatformSupportTier): string {
  return tier === 'tier-1' ? 'Tier 1' : tier === 'tier-2' ? 'Tier 2' : tier === 'experimental' ? 'Experimental' : 'Unsupported'
}
