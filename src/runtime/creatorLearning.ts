...
const panelSpecs: readonly PanelSpec[] = [
  { id: 'project-manager', panel: 'Project Manager', workspace: 'Launcher', features: ['Create project', 'Open project', 'Add existing project', 'Import archive', 'Migration preflight', 'Rollback download', 'Recent projects', 'Project templates'], classifications: ['Assisted', 'Project-wide', 'Reversible'], prerequisites: ['A writable project folder', 'A supported .nova/.json document for import or migration'] },
  ...
  { id: 'ecosystem', panel: 'Packages and Ecosystem Studio', workspace: 'Manage / Debug', features: ['Registry and lockfile', 'Dependency resolution', 'Hashes and signatures', 'Permissions and licenses', 'Quarantine and rollback', 'Offline mirror', 'Plugin API contributions', 'Load, unload and reload', 'Native Extension ABI', 'Package wizard', 'Ed25519 signing request', 'Certification scanner', 'Offline registry tooling', 'Export templates', 'CI matrix', 'Content cache', 'Delta builds', 'Deployment connectors'], classifications: ['Manual', 'Assisted', 'Project-wide', 'Reversible'], prerequisites: ['A reviewed package or extension manifest', 'Explicit permission for native/network operations'] },
