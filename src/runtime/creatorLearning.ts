...
const panelSpecs: readonly PanelSpec[] = [
  ...
  { id: 'visual-graph', panel: 'Visual Graph Editor', workspace: 'Script', features: ['Scratch-style block mode', 'Motion, Looks, Sound, Events, Control, Sensing, Operators, Variables, My Blocks and Extensions categories', 'Advanced typed node mode', 'Automatic Rhai-to-block synchronization', 'Automatic block-to-Rhai generation', 'Code blocks for unsupported Rhai syntax', 'Typed pins and wires', 'Branches and bounded loops', 'Functions and macros', 'Subgraphs and interfaces', 'Graph libraries', 'Variables and exposed properties', 'Breakpoints and active wires', 'Watches and call stack', 'Per-node timings and coverage', 'Refactor and find references', 'Semantic diff and merge', 'Hot reload', 'Package graph nodes', '1,000-node authoring profile'], classifications: ['Manual', 'Assisted', 'Automatic', 'Runtime', 'Reversible'], prerequisites: ['A .nova-graph or .rhai asset'], rhai: ['Generated and parsed Rhai API v2 command stream'], graph: ['All Rhai API v2 generated nodes'] },
