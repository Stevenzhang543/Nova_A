...
const panelSpecs: readonly PanelSpec[] = [
  ...
  { id: 'audio', panel: 'Audio Studio', workspace: 'Animation / Debug', features: ['Audio clips and sources', 'Waveform regions', 'Loop and seek', 'Bus routing', 'Mixer effects and limiter', 'Sends and snapshots', 'Automation and fades', 'Spatial audio', 'Playlists', 'Preload and streaming', 'Voice budgets', 'Device recovery', 'Sample-accurate cinematic frame boundaries', 'Production-media build validation'], classifications: ['Manual', 'Runtime', 'Project-wide', 'Per-object', 'Reversible'], prerequisites: ['An imported audio asset'], rhai: ['audio_play', 'audio_stop', 'audio_set_bus'], graph: ['Audio/Play', 'Audio/Stop'] },
