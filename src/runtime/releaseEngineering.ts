...
export const NOVA_RELEASE_PIPELINE: readonly ReleasePipelineStage[] = Object.freeze([
  ...
  Object.freeze({ id: 'evidence', label: 'Evidence, SBOM and provenance', command: 'pnpm evidence:v7.0.0', required: true, mutation: 'workspace' as const }),
  Object.freeze({ id: 'package', label: 'Eleven-artifact release package', command: 'pnpm release:v7.0.0', required: true, mutation: 'release-output' as const }),
...
export const RELEASE_CANDIDATE_FREEZE = Object.freeze({
  ...
  minimumDays: 14,
  earliestApprovalAt: '2026-09-09T00:00:00.000Z',
