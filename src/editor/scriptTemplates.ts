...
export const SCRIPT_TEMPLATES: readonly ScriptTemplate[] = [
  ...
  { id: 'ui', name: 'UI behavior', description: 'Button callbacks, signals, and UI value updates.', source: `@export(type="string", group="UI", tooltip="Label shown by the UI element") let label = "Ready";
...
` },
  { id: 'physics', name: 'Physics behavior', description: 'Fixed-step force, impulse, and contact callbacks.', source: `@export(type="float", min=0, max=1000, step=0.1, group="Physics", tooltip="Continuous force in newtons") let force = 12.0;
...
` },
  { id: 'animation-event', name: 'Animation event', description: 'Animator control and queued animation signals.', source: `@export(type="string", group="Animation", tooltip="State played at startup") let initial_state = "Idle";
...
` },
  { id: 'test', name: 'Script test', description: 'Deterministic setup, cases, tags, and assertions.', source: `@export(type="integer", min=0, max=100, step=1, group="Tests") let value = 0;
