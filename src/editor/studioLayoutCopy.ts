export const studioLayoutCopy = {
  en: {
    ...
    routingRunning:'Calculating wire routes… Dashed previews are provisional.',arrangeAll:'Arrange all nodes',arrangeSelected:'Arrange selected nodes',cancelLayout:'Cancel layout',layoutRunning:'Arranging nodes…',
  ...
  de: {
    ...
    routingRunning:'Verbindungswege werden berechnet… Gestrichelte Vorschauen sind vorläufig.',arrangeAll:'Alle Knoten anordnen',arrangeSelected:'Ausgewählte Knoten anordnen',cancelLayout:'Anordnung abbrechen',layoutRunning:'Knoten werden angeordnet…',
  ...
  zh: {
    ...
    routingRunning:'正在计算连线路径… 虚线仅为临时预览。',arrangeAll:'整理所有节点',arrangeSelected:'整理选中节点',cancelLayout:'取消整理',layoutRunning:'正在整理节点…',
