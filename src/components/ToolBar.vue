...
<style scoped>
.toolbar { position: absolute; top: 49px; left: 50%; z-index: 240; transform: translateX(-50%); max-width: calc(100vw - 150px); padding: 5px; display: flex; align-items: center; gap: 4px; border: 1px solid var(--border-subtle); border-radius: 13px; background: var(--surface-1); backdrop-filter: var(--glass-blur); box-shadow: var(--shadow-sm); }
...
.tool-key { position: absolute; right: 3px; bottom: 1px; color: var(--text-muted); font-size: 6.5px; font-weight: 700; }
...
@media (max-width: 940px) { .segmented { display: none; } .toolbar { left: calc(50% + 30px); } }
</style>
