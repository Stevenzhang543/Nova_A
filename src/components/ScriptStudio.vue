    ...
    <div class="studio-grid">
      ...
      <main class="code-workspace">
        ...
        <footer class="editor-status">
          ...
          <span>Rhai API v1 · UTF-8</span><span>{{ t('engineVersion') }} 4.0.0</span>
        </footer>
      </main>
...
function sourceChanged() { const asset = activeAsset.value; if (!asset) return; asset.script ??= defaultScriptMetadata(); asset.script.recoverySource = draft.value.slice(0, 1_000_000); dirtyUuids.add(asset.uuid); validationError.value = ''; completionOpen.value = false; void analyzeCurrent(); cursorChanged() }
