    ...
    <div class="studio-grid">
      ...
      <main class="code-workspace">
        ...
        <footer class="editor-status">
          ...
          <span>Rhai · UTF-8</span><span>{{ t('engineVersion') }} 3.2.0</span>
        </footer>
      </main>
      ...
      <aside class="studio-inspector">
        ...
        <div v-else-if="inspectorTab === 'tests'" class="inspector-pane">
          ...
          <article v-for="result in debug.testResults" :key="`${result.script}:${result.test}`" class="test-result"><i :class="{ passed: result.passed }">{{ result.passed ? '✓' : '!' }}</i><span><strong>{{ result.test }}</strong><small>{{ result.script }} · {{ result.message }}</small></span></article>
...
.studio-title { min-width:220px; display:flex; align-items:center; gap:10px; }.studio-title div{display:grid;gap:2px}.studio-title strong{font-size:14px}.studio-title small{color:var(--text-muted);font-size:11px}.studio-mark{width:34px;height:34px;display:grid;place-items:center;border-radius:10px;color:var(--accent);background:var(--accent-soft);font:700 13px ui-monospace,monospace}
...
.studio-inspector{border-left:1px solid var(--border-subtle);display:flex;flex-direction:column}.inspector-tabs{display:grid;grid-template-columns:repeat(4,1fr);border-bottom:1px solid var(--border-subtle)}.inspector-tabs button{min-height:31px;padding:0 4px;border:0;color:var(--text-muted);background:transparent;font-size:11px}.inspector-tabs button.active{color:var(--accent);box-shadow:inset 0 -2px var(--accent)}.inspector-pane{padding:10px;display:flex;flex-direction:column;gap:7px;overflow:auto}.empty-pane,.pane-help{color:var(--text-muted);font-size:11px;line-height:1.5}.problem,.symbol,.test-result{padding:7px;display:flex;align-items:flex-start;gap:8px;border:0;border-radius:7px;text-align:left;color:var(--text-secondary);background:transparent}.problem:hover,.symbol:hover{background:var(--surface-3)}.problem>span,.test-result>span{min-width:0;display:grid;gap:3px}.problem strong,.test-result strong{font-size:11px}.problem small,.test-result small{color:var(--text-muted);font-size:11px}.problem i{width:7px;height:7px;margin-top:4px;border-radius:50%;background:var(--warning)}.problem i.error{background:var(--danger)}.problem i.info{background:var(--accent)}.symbol i{width:18px;color:var(--accent);font-style:normal}.symbol span{flex:1}.symbol small{color:var(--text-muted)}.inspector-pane>code{padding:7px;border-radius:6px;overflow:hidden;text-overflow:ellipsis;background:var(--surface-2);color:var(--accent);font-size:11px}.dependency-editor{display:flex;gap:5px}.dependency-editor input{min-width:0;flex:1}.inspector-pane>label{min-height:34px;padding:5px 7px;display:flex;align-items:center;justify-content:space-between;gap:7px;border:1px solid var(--border-subtle);border-radius:7px}.inspector-pane>label span{min-width:0;display:grid;gap:2px}.inspector-pane>label small{overflow-wrap:anywhere;color:var(--text-muted)}.inspector-pane>label small.error{color:var(--danger)}.inspector-pane>label button,.emit{border:0;color:var(--text-muted);background:transparent}.emit{color:var(--accent)!important}.debug-pane p{padding:7px;border-radius:7px;background:var(--surface-2);color:var(--text-muted)}.debug-pane h3{margin:6px 0 0;font-size:11px;text-transform:uppercase;color:var(--text-muted)}.debug-pane pre{max-height:160px;margin:0;padding:8px;overflow:auto;border-radius:7px;background:var(--bg-canvas);font:11px/1.5 ui-monospace,monospace}.paused{color:var(--warning)}.test-result i{width:20px;height:20px;display:grid;place-items:center;border-radius:50%;font-style:normal;color:#fff;background:var(--danger)}.test-result i.passed{background:var(--success)}.api-reference article{padding:8px;border:1px solid var(--border-subtle);border-radius:8px;background:var(--surface-2)}.api-reference article small{color:var(--accent)}.api-reference article code{display:block;margin:5px 0;color:var(--text-primary);font-size:11px}.api-reference article p{margin:0;color:var(--text-muted);font-size:11px;line-height:1.45}
