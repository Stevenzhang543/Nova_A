...
const commands = computed<EditorCommand[]>(() => [
  ...
  toolCommand('assets', 'assets', 'A'), toolCommand('console', 'console', '>_'), toolCommand('animation', 'animation', '◆'), toolCommand('tilemap', 'tilemap', '▦'), toolCommand('profiler', 'profiler', '⌁'), toolCommand('rendering', 'renderingStudio', 'R'), toolCommand('project', 'projectPanel', 'P'), toolCommand('build', 'buildPanel', 'B'),
