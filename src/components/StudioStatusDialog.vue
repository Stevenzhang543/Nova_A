...
<style scoped>
.support-grid{margin-top:10px;display:grid;grid-template-columns:1fr 1fr;gap:8px}.support-grid>div,.privacy-review{padding:10px;border:1px solid var(--border-subtle);border-radius:10px;background:var(--surface-2)}.support-grid p,.privacy-review p,.privacy-review label,.privacy-review small{color:var(--text-muted);font-size:11px;line-height:1.45}.support-grid b{color:var(--warning)}.privacy-review{margin-top:8px}.privacy-review label{margin:6px 10px 6px 0;display:inline-flex;align-items:center;gap:5px}.privacy-review button{min-height:30px;padding:0 9px}.privacy-review small{margin-left:8px}@media(max-width:600px){.support-grid{grid-template-columns:1fr}}
.release-channels{margin-top:8px;padding:10px;display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:7px;border:1px solid var(--border-subtle);border-radius:10px;background:var(--surface-2)}.release-channels header{grid-column:1/-1;display:flex;align-items:center;justify-content:space-between}.release-channels article{min-width:0;padding:8px;display:grid;gap:3px;border:1px solid var(--border-subtle);border-radius:8px}.release-channels article.active{border-color:var(--accent);background:var(--accent-soft)}.release-channels span,.release-channels small{color:var(--text-muted);font-size:11px}.crash-consent{margin-top:9px;padding-top:8px;border-top:1px solid var(--border-subtle)}@media(max-width:600px){.release-channels{grid-template-columns:1fr}}
</style>
