...
<style scoped>
.rendering-panel{height:100%;min-height:170px;display:grid;grid-template-columns:minmax(180px,22%) minmax(360px,1fr) minmax(190px,24%);overflow:hidden}.render-settings,.render-diagnostics{min-width:0;padding:10px;overflow:auto;background:var(--surface-2)}.render-settings{border-right:1px solid var(--border-subtle)}.render-diagnostics{border-left:1px solid var(--border-subtle)}.render-settings header,.render-diagnostics header{display:flex;flex-direction:column;gap:3px;margin-bottom:8px}.render-settings header small{color:var(--text-muted);font-size:10px;line-height:1.35}.render-settings label,.material-properties label{min-height:31px;display:flex;align-items:center;justify-content:space-between;gap:7px;color:var(--text-muted);font-size:10px}.render-settings input:not([type=checkbox]):not([type=color]),.render-settings select{width:48%;min-width:0}.material-editor{min-width:0;display:flex;flex-direction:column;overflow:hidden}.material-toolbar{padding:7px;display:flex;gap:6px;border-bottom:1px solid var(--border-subtle)}.material-toolbar select{min-width:110px;flex:1}.material-toolbar button,.render-diagnostics button{min-height:30px;padding:0 9px;border:1px solid var(--border-subtle);border-radius:7px;color:var(--text-secondary);background:var(--surface-3);font-size:10px}.material-toolbar button.primary{color:var(--accent);border-color:var(--accent);background:var(--accent-soft)}.material-grid{min-height:0;flex:1;display:grid;grid-template-columns:minmax(250px,1fr) minmax(210px,40%)}.shader-source,.shader-preview{min-width:0;min-height:0;padding:8px;overflow:auto}.shader-source{display:flex;flex-direction:column}.material-properties{display:grid;grid-template-columns:repeat(3,1fr);gap:5px}.material-properties label{display:grid;gap:2px}.shader-source>textarea{min-height:120px;flex:1;resize:none;font:11px/1.55 ui-monospace,SFMono-Regular,Consolas,monospace}.shader-preview canvas{width:100%;aspect-ratio:7/4;display:block;border:1px solid var(--border-subtle);border-radius:8px;background:#161b23}.uniforms{display:grid;grid-template-columns:1fr 1fr;gap:6px;margin-top:7px}.uniforms label{color:var(--text-muted);font-size:9px}.uniforms textarea{width:100%;resize:vertical;font:9px/1.4 ui-monospace,monospace}.diagnostics{margin-top:7px;padding:6px;border:1px solid var(--success);border-radius:7px;color:var(--success);font-size:9px}.diagnostics.error{border-color:var(--danger);color:var(--danger)}.diagnostics p{margin:2px;line-height:1.4}.render-diagnostics header{flex-direction:row;align-items:center;justify-content:space-between}.render-diagnostics dl{margin:0 0 7px;display:grid;grid-template-columns:1fr auto;gap:4px 8px;font-size:9px}.render-diagnostics dt{color:var(--text-muted)}.render-diagnostics dd{margin:0;color:var(--accent)}.render-diagnostics a{display:block;margin-top:5px;overflow:hidden;color:var(--accent);font-size:9px;text-overflow:ellipsis;white-space:nowrap}.allocation{padding:6px;border-radius:7px;color:var(--text-muted);background:var(--surface-3);font-size:9px;line-height:1.4}@media(max-width:900px){.rendering-panel{grid-template-columns:170px minmax(330px,1fr)}.render-diagnostics{display:none}.material-grid{grid-template-columns:1fr}.shader-preview{display:none}}
</style>
