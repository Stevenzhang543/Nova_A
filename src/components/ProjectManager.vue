  ...
  <main class="project-manager">
    <header class="manager-header">
      ...
      <nav aria-label="Project manager utilities">
        ...
        <a href="./manual/index.html" target="_blank" rel="noreferrer">{{ t('manual') }}</a>
...
.manager-header nav { display: flex; align-items: center; gap: 8px; }.manager-header select, .manager-header a, .version { min-height: 30px; padding: 0 10px; display: inline-flex; align-items: center; border: 1px solid var(--border-subtle); border-radius: 8px; color: var(--text-secondary); background: var(--surface-2); font-size: 10px; text-decoration: none; }.version { color: var(--accent); }
...
.manager-header select, .manager-header a, .version { min-height: 32px; font-size: 12px; }
