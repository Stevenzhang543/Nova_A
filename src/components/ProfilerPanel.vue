...
import { captureScriptProfile, clearProfiler, compareScriptProfiles, profilerState } from '../runtime/profiler'
...
const debugOptions = [{ key: 'showColliders', label: 'showColliders' }, { key: 'showContactPoints', label: 'showContactPoints' }, { key: 'showNormals', label: 'showNormals' }, { key: 'showSleepingBodies', label: 'showSleepingBodies' }, { key: 'showAabbs', label: 'showAabbs' }, { key: 'showJointConstraints', label: 'showJointConstraints' }, { key: 'showRopeNodes', label: 'showRopeNodes' }, { key: 'showCharacterContacts', label: 'showCharacterContacts' }, { key: 'colorByPhysicsLayer', label: 'colorByPhysicsLayer' }] as const
