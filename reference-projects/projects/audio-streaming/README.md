...
Demonstrates: streaming import profile and codec metadata, trimmed loop points and gap qualification, device changes, latency and underrun diagnostics. Open the project, run Play/Pause/Step/Stop, and compare the scene/entity minimums and diagnostics with `expected-output.json`.
