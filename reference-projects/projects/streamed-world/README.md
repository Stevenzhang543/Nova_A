...
Demonstrates: explicit cell bounds and ownership, async lifecycle and dependency prefetch, memory budget, cache policy and event log, save-state handoff. Open the project, run Play/Pause/Step/Stop, and compare the scene/entity minimums and diagnostics with `expected-output.json`.
