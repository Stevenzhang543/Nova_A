# Nova_A 4.5 Joint Laboratory

Engine **5.0.1**, Project Format 2, schema 29.

## Expected behavior

- distance, revolute, prismatic, weld, spring and motor joints
- limits, anchors, connected collision and break telemetry
...
3. Select Balanced, then Accurate and Fast; repeat the test IDs: PHY-JOINT-001, PHY-JOINT-004.
