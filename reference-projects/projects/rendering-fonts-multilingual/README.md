...
Demonstrates: scalable and cached bitmap text paths, fallback families, shaping and outlines, English, German and Chinese rendering. Open the project, run Play/Pause/Step/Stop, and compare the scene/entity minimums and diagnostics with `expected-output.json`.
