# Nova_A Prefab variants Reference

Engine **5.0.1**, Project Format 2, schema 29.

## Expected behavior

Demonstrates variant source and override conflicts. Open `project.nova`, use the Design workspace, and compare the result with `expected-output.json`.
