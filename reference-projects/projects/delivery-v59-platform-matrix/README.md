# Platform Template Matrix

Engine **5.9.0**, Project Format 2/schema 29. This reference covers Windows/Web pinned templates, Linux/macOS matching-host gates, Android SDK/template/device fail-closed gates.
