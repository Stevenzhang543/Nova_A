# Nova_A Networked Optional Reference

Engine **5.3.0**, Project Format 2, schema 29.

## Expected behavior

Demonstrates: opt-in Experimental networking package, replication and prediction, diagnostics, headless configuration. Open the project, run Play/Pause/Step/Stop, and compare the scene/entity minimums and diagnostics with `expected-output.json`.
...
```powershell
pnpm nova export --project ./reference-projects/projects/networked-optional/project.nova --target web --profile release --output ./Builds/reference-networked-optional --cache validate --jsonl
```
