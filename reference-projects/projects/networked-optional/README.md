...
Demonstrates: Optional package, Replication, Prediction, Diagnostics, Headless.
...
```powershell
pnpm export -- --project ./reference-projects/projects/networked-optional/project.nova --target web --profile release --output ./Builds/reference-networked-optional
```
