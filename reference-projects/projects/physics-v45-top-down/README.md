# Nova_A 4.5 Top-down Physics

Engine **5.3.0**, Project Format 2, schema 29.

## Expected behavior

- normalized two-axis character velocity
- named-layer interaction
- fixed-profile consistency
...
3. Select Balanced, then Accurate and Fast; repeat the test IDs: PHY-CHAR-006, PHY-PROFILE-001.
