...
Demonstrates: accessible names, roles, values and live regions, scalable text, minimum targets and high contrast. Open the project, run Play/Pause/Step/Stop, and compare the scene/entity minimums and diagnostics with `expected-output.json`.
