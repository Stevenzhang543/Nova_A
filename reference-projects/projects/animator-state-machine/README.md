...
Demonstrates: parameters, transitions and blend trees, live animator debugging. Open the project, run Play/Pause/Step/Stop, and compare the scene/entity minimums and diagnostics with `expected-output.json`.
