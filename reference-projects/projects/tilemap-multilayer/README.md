# Multi-layer Tilemap 2.0

Engine **4.4.0**, Project Format 2, schema 29.

## Expected behavior

Demonstrates: multi-layer tilemap, blend, parallax and z order, collision/navigation/occlusion masks, rotate and mirror transforms. Open the project, run Play/Pause/Step/Stop, and compare the scene/entity minimums and diagnostics with `expected-output.json`.
...
```powershell
pnpm nova export --project ./reference-projects/projects/tilemap-multilayer/project.nova --target web --profile release --output ./Builds/reference-tilemap-multilayer --cache validate --jsonl
```
