# Optional Object Pool Package

Engine **5.0.1**, Project Format 2, schema 29.

## Expected behavior

Demonstrates: optional package enable/disable/removal, reset contracts, capacity and lifetime, reuse and leak diagnostics. Open the project, run Play/Pause/Step/Stop, and compare the scene/entity minimums and diagnostics with `expected-output.json`.
...
```powershell
pnpm nova export --project ./reference-projects/projects/optional-object-pool/project.nova --target web --profile release --output ./Builds/reference-optional-object-pool --cache validate --jsonl
```

## Requirements

- Required packages: top.whitelists.novaa.object-pool@3.8.0.
