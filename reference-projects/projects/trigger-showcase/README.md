# Nova_A Trigger Showcase

Engine **5.0.1**, Project Format 2, schema 29.

## Expected behavior

Demonstrates: trigger enter, stay and exit, stable contact data order. Open the project, run Play/Pause/Step/Stop, and compare the scene/entity minimums and diagnostics with `expected-output.json`.
...
```powershell
pnpm nova export --project ./reference-projects/projects/trigger-showcase/project.nova --target web --profile release --output ./Builds/reference-trigger-showcase --cache validate --jsonl
```
