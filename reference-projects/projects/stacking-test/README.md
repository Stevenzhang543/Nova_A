# Nova_A Stacking Test

Engine **5.3.0**, Project Format 2, schema 29.

## Expected behavior

Demonstrates: stable stacks, friction, restitution, sleep and wake. Open the project, run Play/Pause/Step/Stop, and compare the scene/entity minimums and diagnostics with `expected-output.json`.
...
```powershell
pnpm nova export --project ./reference-projects/projects/stacking-test/project.nova --target web --profile release --output ./Builds/reference-stacking-test --cache validate --jsonl
```
