...
Demonstrates: top-down character motion, triggers, named collision layers. Open the project, run Play/Pause/Step/Stop, and compare the scene/entity minimums and diagnostics with `expected-output.json`.
