...
Demonstrates: Tier-1 browser matrix, deterministic web package, HTTPS/MIME deployment, size, dependency and patch reports. Open the project, run Play/Pause/Step/Stop, and compare the scene/entity minimums and diagnostics with `expected-output.json`.
