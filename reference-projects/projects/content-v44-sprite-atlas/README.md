# Nova_A Sprite and atlas production Reference

Engine **5.0.1**, Project Format 2, schema 29.

## Expected behavior

Demonstrates sprite and atlas production, deterministic save/reload, explicit Main content ownership, and an Assets/** build-inclusion rule that closes the Project Health warning. Open `project.nova`, exercise each control in `test-controls.json`, run Play, save, reload, and compare with `expected-output.json`.
