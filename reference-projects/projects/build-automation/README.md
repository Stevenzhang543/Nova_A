...
Demonstrates: all seven CLI commands, clean/incremental/validated cache modes, content and symbol reports, machine-readable CI logs. Open the project, run Play/Pause/Step/Stop, and compare the scene/entity minimums and diagnostics with `expected-output.json`.
