...
Demonstrates: distance, revolute, prismatic, weld, spring, rope and motor joints, limits and break thresholds. Open the project, run Play/Pause/Step/Stop, and compare the scene/entity minimums and diagnostics with `expected-output.json`.
...
```powershell
pnpm nova export --project ./reference-projects/projects/joint-showcase/project.nova --target web --profile release --output ./Builds/reference-joint-showcase --cache validate --jsonl
```
