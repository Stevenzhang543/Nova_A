# Nova 26.24 Output Quality Workshop
...
14. Change the editor palette through Settings; switch light/dark and reopen. **Expected:** Editor colors persist independently of game colors and saved project rendering settings.
