# Nova 26.14 Coin Trail — code

Public release **26.14** · Engine **26.14.0** · Project Format 2/schema 29.

Authoring: Rhai code with synchronized typed companion. The same Coin Trail scene, input map and gameplay source are used by all three variants. Only the blocks variant attaches the graph asset directly. Both modes use the same runtime module resolver and command path.
