# Offline Registry Delivery

Engine **5.9.0**, Project Format 2/schema 29. This reference covers canonical package manifest and Ed25519 request, bounded offline registry import, no download or implicit execution.
