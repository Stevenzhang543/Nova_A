# Nova_A RTL Interface

Engine **5.3.0**, Project Format 2, schema 29.

## Expected behavior

Demonstrates: right-to-left direction preview, mirrored focus and layout behavior. Open the project, run Play/Pause/Step/Stop, and compare the scene/entity minimums and diagnostics with `expected-output.json`.
...
```powershell
pnpm nova export --project ./reference-projects/projects/rtl-interface/project.nova --target web --profile release --output ./Builds/reference-rtl-interface --cache validate --jsonl
```
