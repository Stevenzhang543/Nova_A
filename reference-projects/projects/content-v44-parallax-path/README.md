# Nova_A Parallax and reusable paths Reference

Engine **5.3.0**, Project Format 2, schema 29.

## Expected behavior

Demonstrates parallax and reusable paths, deterministic save/reload, explicit Main content ownership, and an Assets/** build-inclusion rule that closes the Project Health warning. Open `project.nova`, exercise each control in `test-controls.json`, run Play, save, reload, and compare with `expected-output.json`.
