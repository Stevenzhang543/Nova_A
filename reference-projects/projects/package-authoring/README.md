...
Demonstrates: manifest types and API range, permission review and escalation, signature failure and quarantine, offline lock and verified rollback. Open the project, run Play/Pause/Step/Stop, and compare the scene/entity minimums and diagnostics with `expected-output.json`.
