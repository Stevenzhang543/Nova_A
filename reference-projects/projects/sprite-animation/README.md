# Nova_A Sprite Animation

Engine **5.3.0**, Project Format 2, schema 29.

## Expected behavior

Demonstrates: sprite frame tracks and onion skin, events, audio and nested animation tracks. Open the project, run Play/Pause/Step/Stop, and compare the scene/entity minimums and diagnostics with `expected-output.json`.
...
```powershell
pnpm nova export --project ./reference-projects/projects/sprite-animation/project.nova --target web --profile release --output ./Builds/reference-sprite-animation --cache validate --jsonl
```
