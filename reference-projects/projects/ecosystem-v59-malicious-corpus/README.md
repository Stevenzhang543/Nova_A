...
Engine **5.9.0**, Project Format 2/schema 29. This reference covers path traversal and archive bomb rejection, hidden executable and permission rejection, native sidecar separation.
