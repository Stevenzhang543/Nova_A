# Bounded Navigation 5.7

Engine **5.7.0**, Project Format 2/schema 29. This navigation reference validates authored data, save/reload, bounded runtime behavior, cancellation and deterministic output.

## Compatibility

- Required packages: Nova Navigation.
