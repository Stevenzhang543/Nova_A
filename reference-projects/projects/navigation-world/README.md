# Grid and Polygon Navigation

Engine **5.3.0**, Project Format 2, schema 29.

## Expected behavior

Demonstrates: grid and polygon navigation, costs, links and regions, dynamic obstacles and avoidance, navigation profiling. Open the project, run Play/Pause/Step/Stop, and compare the scene/entity minimums and diagnostics with `expected-output.json`.
...
```powershell
pnpm nova export --project ./reference-projects/projects/navigation-world/project.nova --target web --profile release --output ./Builds/reference-navigation-world --cache validate --jsonl
```
