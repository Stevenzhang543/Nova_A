...
Demonstrates: camera stacking, split viewports, pixel-perfect preview, camera frame overlays. Open the project, run Play/Pause/Step/Stop, and compare the scene/entity minimums and diagnostics with `expected-output.json`.
