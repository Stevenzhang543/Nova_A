# Nova_A Controller Navigation

Engine **5.0.1**, Project Format 2, schema 29.

## Expected behavior

Demonstrates: focus-order visualization, keyboard and gamepad directional navigation. Open the project, run Play/Pause/Step/Stop, and compare the scene/entity minimums and diagnostics with `expected-output.json`.
...
```powershell
pnpm nova export --project ./reference-projects/projects/controller-navigation/project.nova --target web --profile release --output ./Builds/reference-controller-navigation --cache validate --jsonl
```
