...
Demonstrates: experimental transport/RPC/authority contracts, replication, prediction and diagnostics, headless fixed-tick interface, security and packet-loss gates.
