...
Demonstrates: 5,000 objects, performance mode, component and tag search, box selection. Open the project, run Play/Pause/Step/Stop, and compare the scene/entity minimums and diagnostics with `expected-output.json`.
