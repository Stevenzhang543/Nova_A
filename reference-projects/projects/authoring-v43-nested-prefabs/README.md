# Nova_A Nested prefabs Reference

Engine **5.0.1**, Project Format 2, schema 29.

## Expected behavior

Demonstrates nested prefab layers and cycle rejection. Open `project.nova`, use the Design workspace, and compare the result with `expected-output.json`.
