...
Demonstrates: API v1 handles, input, physics, animation, audio, navigation, save and resources. Open the project, run Play/Pause/Step/Stop, and compare the scene/entity minimums and diagnostics with `expected-output.json`.
...
```powershell
pnpm nova export --project ./reference-projects/projects/script-api-v1-examples/project.nova --target web --profile release --output ./Builds/reference-script-api-v1-examples --cache validate --jsonl
```
