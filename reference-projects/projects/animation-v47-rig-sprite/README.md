...
Sprite-frame animation, a 2D bone rig, skin weights, constraints, IK, attachments and retarget aliases.

## Test procedure

1. Open `project.nova` and switch to **Animation**.
