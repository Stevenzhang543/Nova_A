...
Demonstrates: structured string tables and CSV, context, plural forms, fallback metadata and extraction. Open the project, run Play/Pause/Step/Stop, and compare the scene/entity minimums and diagnostics with `expected-output.json`.
