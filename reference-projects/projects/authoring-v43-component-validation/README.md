# Nova_A Component validation Reference

Engine **4.4.0**, Project Format 2, schema 29.

## Expected behavior

Demonstrates dependency and conflict reporting. Open `project.nova`, use the Design workspace, and compare the result with `expected-output.json`.
