...
Demonstrates: line/function/conditional/hit-count breakpoints, logpoints, locals, watches and callback stacks. Open the project, run Play/Pause/Step/Stop, and compare the scene/entity minimums and diagnostics with `expected-output.json`.
...
```powershell
pnpm nova export --project ./reference-projects/projects/script-debugger-scenarios/project.nova --target web --profile release --output ./Builds/reference-script-debugger-scenarios --cache validate --jsonl
```
