# Nova_A Platformer Character

Engine **4.4.0**, Project Format 2, schema 29.

## Expected behavior

Demonstrates: character slopes and steps, moving platform behavior, floor/wall/ceiling contacts. Open the project, run Play/Pause/Step/Stop, and compare the scene/entity minimums and diagnostics with `expected-output.json`.
...
```powershell
pnpm nova export --project ./reference-projects/projects/platformer-character/project.nova --target web --profile release --output ./Builds/reference-platformer-character --cache validate --jsonl
```
