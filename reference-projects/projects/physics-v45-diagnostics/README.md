# Nova_A 4.5 Physics Diagnostics

Engine **5.0.1**, Project Format 2, schema 29.

## Expected behavior

- virtual body monitor, sorting, pins and sparklines
- collision and constraint timelines
- capture export and snapshot comparison
...
3. Select Balanced, then Accurate and Fast; repeat the test IDs: PHY-DIAG-001, PHY-DIAG-004.
