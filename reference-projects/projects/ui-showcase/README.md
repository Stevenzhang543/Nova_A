...
Demonstrates: Responsive UI, Themes, Localization, Focus, Audio mixer. Open the project, run Play/Pause/Step/Stop, and compare the scene/entity minimums and diagnostics with `expected-output.json`.
...
```powershell
pnpm nova export --project ./reference-projects/projects/ui-showcase/project.nova --target web --profile release --output ./Builds/reference-ui-showcase --cache validate --jsonl
```
