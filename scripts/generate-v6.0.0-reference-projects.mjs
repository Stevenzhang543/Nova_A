/** 版本6.0.0：生成参考项目与对应资源，供功能演示和版本验证使用。 */
...
const block = `${markerStart}\n## Nova_A 6.0 complete teaching projects\n\n${specs.map(/** 生成参考项目标题链接和用途说明。 */ spec => `- [${spec.title}](projects/${spec.id}/README.md) — ${spec.focus}.`).join('\n')}\n${markerEnd}`
