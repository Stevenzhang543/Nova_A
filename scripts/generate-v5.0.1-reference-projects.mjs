/** 版本5.0.1：生成参考项目与对应资源，供功能演示和版本验证使用。 */
...
/** 升级5.0.1包兼容范围并按官方映射补齐来源和安全元数据。 */ function refreshPackage(item) {
...
/** 升级5.0.1项目身份并同步包锁及内嵌包兼容范围。 */ function refreshProject(project) {
...
/** 设置5.0.1参考身份、发布能力清单及默认团队配置。 */ function updateProject(project, slug, title, features) {
