...
const root=dirname(dirname(fileURLToPath(import.meta.url))),output=join(root,'docs/FEATURE_INVENTORY_26_03.md'),compiled=await mkdtemp(join(tmpdir(),'nova-v2603-inventory-'))
...
try{
  ...
  lines.push('## 26.03 focus','','Optional Rhai types/data contracts, module diagnostics, stable statements, breakpoint remapping, task cancellation, live block values, LSP 3.17, conversion coverage, explicit Execute Rhai blocks, structural diff, and semantic merge are additive to the same seven-dimension matrix.','')
