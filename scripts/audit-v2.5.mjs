...
assert(format.includes('Some(1 | 2)') && format.includes('validate_packages') && format.includes('CURRENT_FORMAT_VERSION: u32 = 29'), 'authoritative schema does not validate legacy/API 2 plugins and packages')
