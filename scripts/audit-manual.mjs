...
assert(html.includes(`<title>Nova_A ${engineVersion} Manual</title>`) && html.includes(`${engineVersion} Offline Teaching Manual`) && new RegExp(`Engine\\s+${engineVersion.replaceAll('.', '\\.')}`).test(html), 'HTML manual metadata is stale')
