...
assert(html.includes(`<title>Nova_A ${engineVersion} Manual</title>`) && html.includes(`${engineVersion} Offline Teaching Manual`) && html.includes(`Engine ${engineVersion}`), 'HTML manual metadata is stale')
