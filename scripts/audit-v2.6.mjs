...
assert(tilePanel.includes('navigationPolygon') && palette.includes("id: 'tool-tilemap'"), 'navigation/tile workflow is not discoverable after removal of World Tools')
