...
assert(format.includes('CURRENT_FORMAT_VERSION: u32 = 23') && project.includes('NOVA_PROJECT_SCHEMA_VERSION = 23') && format.includes('projectSettings.world'), 'current-schema world settings are not authoritative')
