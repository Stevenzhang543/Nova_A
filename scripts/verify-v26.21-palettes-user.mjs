...
await runMilestoneBrowserAudit(context,{name,height:1000},async a=>{
 ...
 await a.check('Reset Settings restores both palette defaults',async()=>{await u.open(join(context.repository,'reference-projects/projects/creator-v2621-code-game/project.nova'));await settings();
