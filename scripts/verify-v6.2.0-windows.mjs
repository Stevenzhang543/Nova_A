...
const version=process.env.NOVA_WINDOWS_VERSION||'6.2.0',referenceName=process.env.NOVA_WINDOWS_REFERENCE||'creator-v620-behavior-contract',gameName=process.env.NOVA_WINDOWS_GAME_NAME||'Contract Knockout'
...
const game = join(output, `${gameName}.exe`)
