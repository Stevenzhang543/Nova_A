...
try {
  ...
  const report = { format: 'nova-editor-browser-qualification', version: 1, engineVersion: '3.1.0', generatedAt: new Date().toISOString(), browser: browser.product, status: results.every(/* 比较 item.status 与 'passed'，返回严格相等的判断结果。 */ item => item.status === 'passed') ? 'passed' : 'failed', resolutions: screenshots, results, consoleErrors }
