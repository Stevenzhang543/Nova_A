/** 版本6.9.0：汇集发布报告与产物文件，生成带来源记录的发布证据。 */
...
await writeJson(join(evidence, 'external/gates.json'), { format: 'nova-external-certification-gates', version: 1, release: version, generatedAt, gates: ['live dependency advisory registry lookup', 'publisher identity and release signing', 'independent clean-machine install/launch/upgrade/repair/uninstall', 'second-machine byte reproduction', 'Linux and macOS matching-host builds', 'independent package security review', 'independent accessibility review', 'real 72-hour editor/player soak'].map(/** 为指定外部资格生成待外部验证且不声称通过的条目。 */ name => ({ name, status: 'pending-external', claimed: false })) })
