/* 审计 3.3 的事务创建、视口工具、层级、多选编辑、组件生命周期及相机作者工作流。 */
...
check('localized authoring interface', ['Create object','Objekt erstellen','创建对象'].every(/* 调用 i18n.includes(label) 并返回调用结果。 */ label => i18n.includes(label)), 'English, German, and Simplified Chinese authoring controls are available.')
...
console.log(`v3.3 authoring audit ${report.status} (${checks.filter(/* 比较 item.status 与 'passed'，返回严格相等的判断结果。 */ item => item.status === 'passed').length}/${checks.length}).`)
