/** 版本5.6.0：汇集发布报告与产物文件，生成带来源记录的发布证据。 */
...
if ([product, verification, layout].some(/* 比较 report.status 与 'passed'，返回严格不等的判断结果。 */ report => report.status !== 'passed')) throw new Error('Product, production and layout audits must pass before evidence generation.')
