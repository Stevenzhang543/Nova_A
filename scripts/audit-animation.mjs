...
assert(format.includes('CURRENT_FORMAT_VERSION: u32 = 23') && format.includes('Skeleton2D') && format.includes('TimelinePlayer'), 'current schema component validation is not active')
