...
await withBrowserAudit({release:'26.21',name:'hierarchy-user',development:process.argv.includes('--development'),expectedRelease:'26.21',height:1000,commandTimeoutMs:profileLoad?30000:120000},async a=>{
