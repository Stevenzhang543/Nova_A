...
const paths = {
  ...
  msi: join(root, 'src-tauri', 'target', 'release', 'bundle', 'msi', 'Nova_A_3.8.0_x64_en-US.msi'),
  setup: join(root, 'src-tauri', 'target', 'release', 'bundle', 'nsis', 'Nova_A_3.8.0_x64-setup.exe')
}
const artifacts = {}
...
console.log(`Nova_A v3.8 Windows smoke ${report.status}: portable stayed alive for ${report.launchSeconds}s; MSI/NSIS/portable hashes captured.`)
