...
await withBrowserAudit({release:'26.21',name:'layout-user',expectedRelease:'26.21',width:1366,height:768},async a=>{
 const u=worldUserControls17(a);await u.open(join(process.cwd(),'reference-projects/projects/creator-v2621-code-game/project.nova'));await u.entity('Player')
